...
def paragogi_syntaghs(ktima_id):
    ...
    try:
        ...
        prompt = (
            ...
            f"1δ. ΥΠΟΛΟΓΙΣΜΟΣ ΔΟΣΟΛΟΓΙΑΣ & ΙΣΤΟΡΙΚΟ: Υπολόγισε την προτεινόμενη συνολική δοσολογία με βάση τον Αριθμό Δέντρων και την Ηλικία. ΑΝ από το 'ΙΣΤΟΡΙΚΟ ΠΡΟΒΛΗΜΑΤΩΝ, ΦΩΤΟΓΡΑΦΙΩΝ & ΕΥΡΗΜΑΤΩΝ ΓΡΑΜΜΑΤΕΑ' προκύπτει πρόσφατη αναγνώριση ασθένειας (π.χ. Κυκλοκόνιο, μύκητες) ή συγκεκριμένο στάδιο, ΛΑΒΕ ΤΟ ΣΟΒΑΡΑ ΥΠΟΨΗ για τη συνταγή σου, προσαρμόζοντας τα φάρμακα ή τις δόσεις. Παρουσίασε αναλυτικά τους υπολογισμούς στο κείμενο.\n"

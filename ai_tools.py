...
def analysi_egrafou(ktima_id):
    ...
    try:
        prompt = "Διάβασε αυτά τα έγγραφα ανάλυσης εδάφους/φύλλων. ΜΗΝ γράψεις αναφορά ή συμπέρασμα. Κατάγραψε απλώς αναλυτικά όλα τα στοιχεία (ιχνοστοιχεία, μακροστοιχεία, κτλ) και τις τιμές/μετρήσεις τους σε μορφή λίστας, ακριβώς όπως αναγράφονται στο φύλλο της ανάλυσης."
        contents = [prompt]

...
class Ktima(vasi.Model):
    ...
    ugrasies = vasi.relationship('KatagrafiUgrasias', backref='ktima', lazy=True, cascade="all, delete-orphan", order_by="desc(KatagrafiUgrasias.imerominia)")
    arxeia_sygkomidis = vasi.relationship('ArxeioSygkomidis', backref='ktima', lazy=True, cascade="all, delete-orphan", order_by="desc(ArxeioSygkomidis.imerominia)")
    analuseis_edafous = vasi.relationship('AnalysiEdafous', backref='ktima', lazy=True, cascade="all, delete-orphan", order_by="desc(AnalysiEdafous.imerominia)")
    analuseis_fyllon = vasi.relationship('AnalysiFyllon', backref='ktima', lazy=True, cascade="all, delete-orphan", order_by="desc(AnalysiFyllon.imerominia)")
    pagides = vasi.relationship('Pagides', backref='ktima', lazy=True, cascade="all, delete-orphan", order_by="desc(Pagides.imerominia)")
    ...
    diagnoseis = vasi.relationship('Diagnosi', backref='ktima', lazy=True, cascade="all, delete-orphan", order_by="desc(Diagnosi.imerominia)")
    ergasies = vasi.relationship('Ergasia', backref='ktima', lazy=True, cascade="all, delete-orphan", order_by="desc(Ergasia.imerominia)")
    exoda = vasi.relationship('Exodo', backref='ktima', lazy=True, cascade="all, delete-orphan", order_by="desc(Exodo.imerominia)")
    syntages = vasi.relationship('Syntagh', backref='ktima', lazy=True, cascade="all, delete-orphan", order_by="desc(Syntagh.imerominia)")

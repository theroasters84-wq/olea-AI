...
def generate_smart_tasks(ktima):
    ...
    prompt = (
        f"Είσαι έμπειρος γεωπόνος και ερευνητής. Ανάλυσε τα δεδομένα του ελαιώνα και πρότεινε ΟΛΕΣ τις απαραίτητες εργασίες για την τρέχουσα περίοδο βασισμένος σε σύγχρονες γεωπονικές μελέτες.\n"
        f"{plires_context}\n"
        f"--- ΟΔΗΓΙΑ ---\n"
        ...
        f"ΒΑΣΙΚΗ ΠΡΟΛΗΨΗ & ΔΟΣΟΛΟΓΙΕΣ: Αν από το 'Ιστορικό Προβλημάτων' προκύπτει ότι πέρυσι υπήρξε έξαρση (π.χ. Δάκος, Κυκλοκόνιο), ΠΡΟΣΑΡΜΟΣΕ το πρόγραμμα κάνοντάς το πιο επιθετικό (π.χ. νωρίτερα ψεκασμοί, ανώτατη επιτρεπτή δόση). Την Άνοιξη (Μάρτιο-Απρίλιο) και το Φθινόπωρο, ο προληπτικός ψεκασμός με Χαλκό/Μυκητοκτόνο για ασθένειες (π.χ. Κυκλοκόνιο) είναι ΥΠΟΧΡΕΩΤΙΚΟΣ. Αν δεν έχει γίνει πρόσφατα, βάλτον στις κορυφαίες προτεραιότητες, ΕΚΤΟΣ αν το δέντρο ανθίζει ή είναι πολύ κοντά στην άνθιση, οπότε ΜΗΝ τον προτείνεις γιατί θα κάψει το άνθος.\n"
        f"ΣΥΓΧΩΝΕΥΣΗ ΨΕΚΑΣΜΩΝ (TANK MIX): Αν προτείνεις 2 ή παραπάνω ψεκασμούς/θεραπείες (π.χ. Κάλιο, Αμινοξέα, Βόριο), ΣΥΓΧΩΝΕΥΣΕ τους ΑΥΣΤΗΡΑ σε ΜΙΑ (1) ενιαία εργασία (π.χ. 'Ψεκασμός: Κάλιο + Αμινοξέα') ΕΦΟΣΟΝ είναι επιστημονικά συμβατά! Μην προτείνεις στον αγρότη 2 ξεχωριστούς ψεκασμούς με διαφορά 2-5 ημερών.\n"
...
def syghronismos_ai_ktimatos(ktima):
    ...
    prompt = (
        f"Είσαι ο Κορυφαίος AI Γεωπόνος του Olea. Έχεις πρόσβαση στο ίντερνετ για να διασταυρώνεις πρακτικές με επιστημονικές μελέτες. Μελέτησε σχολαστικά τα δεδομένα του κτήματος:\n{plires_context}\n\n"
        f"ΟΔΗΓΙΕΣ:\n"
        f"1. Γράψε μια σύντομη ημερήσια συμβουλή-αξιολόγηση (max 2-3 προτάσεις). Ξεκίνα με τη λέξη 'ΣΥΜΒΟΥΛΗ:'. ΔΙΑΣΤΑΥΡΩΣΗ ΣΤΑΔΙΟΥ & GDD: Αξιολόγησε αν το δηλωμένο στάδιο ταιριάζει με τα Τρέχοντα GDD. Αν υπάρχει μεγάλη απόκλιση, ενημέρωσε τον αγρότη να επικαιροποιήσει το στάδιο! Αν προτείνεις εργασία με αυστηρή προθεσμία, ΠΡΟΕΙΔΟΠΟΙΗΣΕ τον αγρότη ξεκάθαρα εδώ.\n"
        ...
        f"ΒΑΣΙΚΗ ΠΡΟΛΗΨΗ & ΔΟΣΟΛΟΓΙΕΣ: Αν από το ιστορικό προκύπτει ότι πέρυσι υπήρξε σοβαρό πρόβλημα (π.χ. Δάκος, ασθένειες), ΠΡΟΣΑΡΜΟΣΕ το πρόγραμμα προληπτικά (πιο συχνοί ψεκασμοί, ανώτατη δόση). Την Άνοιξη (Μάρτιο-Απρίλιο) ο ψεκασμός με Χαλκό/Μυκητοκτόνο είναι κρίσιμος. Αν δεν υπάρχει στο ιστορικό, πρόσθεσέ τον, ΕΚΤΟΣ αν το δέντρο ανθίζει (ή είναι πολύ κοντά), οπότε ΑΠΑΓΟΡΕΥΕΤΑΙ ο ψεκασμός για να μην καεί το άνθος.\n"
        f"ΣΥΓΧΩΝΕΥΣΗ ΨΕΚΑΣΜΩΝ (TANK MIX): Συνδύασε πολλαπλούς ψεκασμούς (π.χ. Κάλιο + Αμινοξέα) σε 1 ενιαία εργασία εφόσον είναι επιστημονικά συμβατοί, για οικονομία χρόνου και κόπου. Απαγορεύεται να προτείνεις ξεχωριστούς ψεκασμούς την ίδια εβδομάδα αν μπορούν να μπουν στο ίδιο βυτίο!\n"

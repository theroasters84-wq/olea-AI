...
def generate_smart_tasks(ktima):
    ...
    prompt = (
        ...
        f"{plires_context}\n"
        f"--- ΟΔΗΓΙΑ ---\n"
        f"ΕΙΔΙΚΟΣ ΚΑΝΟΝΑΣ ΓΙΑ ΧΟΡΤΑ/ΖΙΖΑΝΙΑ: Μην προτείνεις τυφλά 'Κοπή Χόρτων' ή 'Ζιζανιοκτονία' απλά επειδή είναι Άνοιξη. Αν στο ιστορικό φαίνεται ότι έγινε ψεκασμός ζιζανίων ή κοπή τους τελευταίους 2-3 μήνες, πιθανόν να μην υπάρχουν χόρτα. Πρότεινε διαχείριση χόρτων ΜΟΝΟ αν ο Δορυφόρος, μια πρόσφατη Διάγνωση/Φωτογραφία, ή ο αγρότης επιβεβαιώνουν ρητά την ύπαρξη χόρτων. Επίσης, αν το κτήμα είναι Βιολογικό, απαγορεύεται ο ψεκασμός με ζιζανιοκτόνα (μόνο κοπή).\n"
...
def syghronismos_ai_ktimatos(ktima):
    ...
    prompt = (
        ...
        f"ΕΞΥΠΝΗ ΔΙΑΧΕΙΡΙΣΗ ΧΟΡΤΩΝ: Η 'Κοπή Χόρτων' και ο 'Ψεκασμός Ζιζανίων' είναι διαφορετικές πρακτικές. Αν στο ιστορικό ψέκασε τον χειμώνα, ίσως να μην έχει καθόλου χόρτα τώρα. ΜΗΝ προτείνεις εργασία χόρτων τυφλά λόγω άνοιξης. Αν δεν έχεις εικόνα (από δορυφόρο/φωτογραφία/αγρότη) ότι υπάρχουν χόρτα, Η ΕΡΩΤΗΣΗ σου πρέπει να είναι π.χ.: 'Βλέπω παλιότερες εργασίες / Δεν έχω εικόνα του εδάφους. Έχουν βγει χόρτα; Και αν ναι, προτιμάτε κόψιμο ή ψεκασμό;'.\n"
